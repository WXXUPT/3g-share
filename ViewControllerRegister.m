...
- (void)viewDidLoad {
    ...
    UILabel *kaijiLabel = [[UILabel alloc] initWithFrame:CGRectMake(150, 200, 100, 50)];
    ...
    lineImageView2.frame = CGRectMake(50, 10, 2, 30);
    ...
    lineImageView3.frame = CGRectMake(50, 10, 2, 30);
    ...
    _massTextField = [[UITextField alloc] initWithFrame:CGRectMake(30, 260, 320, 45)];
    ...
    _userTextField = [[UITextField alloc] initWithFrame:CGRectMake(30, 320, 320, 45)];
    ...
    _passTextField = [[UITextField alloc] initWithFrame:CGRectMake(30, 380, 320, 45)];
    ...
    [_btn addTarget:self action:@selector(pressRegister:) forControlEvents:UIControlEventTouchDown];
...
{
    [self.massTextField resignFirstResponder];
