...
- (void)viewDidLoad {
    ...
    UITabBarItem* tabBarItem = [UITabBarItem new];
       tabBarItem.image = [[UIImage imageNamed:@"button2_normal.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
       tabBarItem.selectedImage = [[UIImage imageNamed:@"button2_pressed.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    _searchTextField = [[UITextField alloc] initWithFrame:CGRectMake(5, 110, 400, 30)];
    UIImage *image = [UIImage imageNamed:@"放大镜.png"];
    UIImageView *imageView = [[UIImageView alloc] initWithImage:image];
    imageView.frame = CGRectMake(5, 0, 20, 20);
    ...
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(5, 160, 60, 25)];
    ...
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(5, 270, 60, 25)];
    ...
    UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(5, 345, 60, 25)];
    ...
    fenButton1.frame = CGRectMake(5, 200, 96, 20);
    ...
    fenButton2.frame = CGRectMake(85, 200, 96, 20);
    ...
    fenButton3.frame = CGRectMake(85+80, 200, 96, 20);
    ...
    fenButton4.frame = CGRectMake(85+80+80, 200, 96, 20);
    [fenButton4 setTitle:@"插画/手绘" forState:UIControlStateNormal];
    
    UIButton *fenButton5= [UIButton buttonWithType:UIButtonTypeRoundedRect];
    fenButton5.frame = CGRectMake(2, 235, 120, 20);
    [fenButton5 setTitle:@"虚拟与设计" forState:UIControlStateNormal];
    [self.view addSubview:fenButton5];
    [fenButton5 addTarget:self action:@selector(pressSelect:) forControlEvents:UIControlEventTouchDown];
    fenButton5.tintColor = [UIColor blackColor];
    fenButton5.layer.cornerRadius = 5;
    fenButton5.backgroundColor = [UIColor whiteColor];
    
    UIButton *fenButton6 = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    fenButton6.frame = CGRectMake(85, 235, 89, 20);
    [fenButton6 setTitle:@"影视" forState:UIControlStateNormal];
    [self.view addSubview:fenButton6];
    [fenButton6 addTarget:self action:@selector(pressSelect:) forControlEvents:UIControlEventTouchDown];
    fenButton6.tintColor = [UIColor blackColor];
    fenButton6.layer.cornerRadius = 5;
    fenButton6.backgroundColor = [UIColor whiteColor];
    
    UIButton *fenButton7= [UIButton buttonWithType:UIButtonTypeRoundedRect];
    fenButton7.frame = CGRectMake(85+80, 235, 96, 20);
    fenButton7.tintColor = [UIColor blackColor];
    [fenButton7 addTarget:self action:@selector(pressSelect:) forControlEvents:UIControlEventTouchDown];
    fenButton7.layer.cornerRadius = 5;
    fenButton7.backgroundColor = [UIColor whiteColor];
    [fenButton7 setTitle:@"摄影" forState:UIControlStateNormal];
    [self.view addSubview:fenButton7];
    
    UIButton *fenButton8 = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    fenButton8.tintColor = [UIColor blackColor];
    [fenButton8 addTarget:self action:@selector(pressSelect:) forControlEvents:UIControlEventTouchDown];
    fenButton8.layer.cornerRadius = 5;
    fenButton8.backgroundColor = [UIColor whiteColor];
    fenButton8.frame = CGRectMake(85+80+80, 235, 96, 20);
    [fenButton8 setTitle:@"其他" forState:UIControlStateNormal];
    [self.view addSubview:fenButton8];
    ...
    tuiButton1.frame = CGRectMake(5, 310, 96, 20);
    ...
    tuiButton2.frame = CGRectMake(85, 310, 96, 20);
    ...
    tuiButton3.frame = CGRectMake(85+80, 310, 96, 20);
    ...
    tuiButton4.frame = CGRectMake(85+160, 310, 96, 20);
    ...
    timeButton1.frame = CGRectMake(5, 385, 96, 20);
    ...
    timeButton2.frame = CGRectMake(85, 385, 96, 20);
    ...
    timeButton3.frame = CGRectMake(85+80, 385, 96, 20);
    ...
    timeButton4.frame = CGRectMake(85+160, 385, 96, 20);
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    SonViewController *root = [[SonViewController alloc] init];
