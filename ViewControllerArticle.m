...
- (void)viewDidLoad {
    ...
    _segmentedControl.frame = CGRectMake(0, 88, [UIScreen mainScreen].bounds.size.width, 45);
    ...
    [_tableView1 registerClass:[TableViewCellGouGou7 class] forCellReuseIdentifier:@"1"];
    [_tableView2 registerClass:[TableViewCellGouGou7 class] forCellReuseIdentifier:@"2"];
    [_tableView3 registerClass:[TableViewCellGouGou7 class] forCellReuseIdentifier:@"3"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {
        TableViewCellGouGou7 *cell1 = [_tableView1 dequeueReusableCellWithIdentifier:@"1" forIndexPath:indexPath];
        ...
        TableViewCellGouGou7 *cell2 = [_tableView2 dequeueReusableCellWithIdentifier:@"2" forIndexPath:indexPath];
        ...
        TableViewCellGouGou7 *cell3 = [_tableView3 dequeueReusableCellWithIdentifier:@"3" forIndexPath:indexPath];
